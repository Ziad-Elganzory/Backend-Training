...
- What problem does Singleton solve?
    - Singleton Ensures that the class has just a single instance and Provide a global access point to that instance and it controls access to a shared resource.
